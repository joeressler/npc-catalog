...
class GraphEdge(Base):
    ...
    from_kind: Mapped[str] = mapped_column(String(20))
    from_npc_id: Mapped[int | None] = mapped_column(ForeignKey("npcs.id", ondelete="CASCADE"), nullable=True)
    to_kind: Mapped[str] = mapped_column(String(20))
    to_npc_id: Mapped[int | None] = mapped_column(ForeignKey("npcs.id", ondelete="CASCADE"), nullable=True)
    notes: Mapped[str] = mapped_column(Text, default="")
